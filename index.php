...
<body class=" bgimage" id="body" onload="spinner();">
    ...
    <div class="col-12 ">
        <div id="spinner"
            ...
            <!-- <l-ripples size="70" speed="2" color="orange"></l-ripples> -->
            <l-waveform size="45" stroke="3.5" speed="1.2" color="orange"></l-waveform>
            ...
            <nav class="navbar navbar-dark navbar-expand-lg px-0 py-0">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand d-flex align-items-center mx-auto" href="#">
                        <img src="./resources/shoeplazanav.png" class="rounded-pill img-fluid" alt="Logo" width="70"
                            onclick="refreshPage();">
                        <!-- Uncomment this span for text logo -->
                        <span class="fw-bold text-light" onclick="refreshPage();"
                            style="font-family:Verdana, Geneva, Tahoma, sans-serif; letter-spacing: 1px; font-size: 20px; ">SHOE
                    ...
                    <div class="collapse navbar-collapse justify-content-center align-items-center flex-row"
                        ...
                        <ul class="navbar-nav mb-2 mb-lg-0">
                            <li class="nav-item mx-3 p-3 ">
                                <a class="nav-link active custom-font text-light fw-semibold p-0 navfont" aria-current="page" href="#"
                                    onclick="refreshPage();">Home</a>
                            </li>

                            <!-- Dropdown for Category -->
                            <li class="nav-item dropdown mx-3 p-3">
                                <a class="nav-link dropdown-toggle custom-font text-light fw-semibold p-0 navfont" href="#" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    Category
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item dropdownFont" href="#">Men's Shoes</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item dropdownFont" href="#">Women's Shoes</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item dropdownFont" href="#">Kids Shoes</a></li>
                                </ul>
                            </li>

                            <li class="nav-item mx-3 p-3">
                                <a class="nav-link custom-font text-light fw-semibold p-0 navfont" href="#">Our Story</a>
                            </li>

                            <li class="nav-item mx-3 p-3">
                                <a class="nav-link custom-font text-light fw-semibold p-0 navfont" href="#">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                </div>
